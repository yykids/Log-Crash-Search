...
### Feb. 25, 2020
#### Feature Updates
* [Console] 설정 화면 툴팁 가이드 개선
* [Console] 쿼리 저장 시 루씬 쿼리 유효성 검증 과정 추가
#### Bug Fixes 
* [Console] 설정 화면 윈도우즈 크래시 심볼리케이션을 위한 심볼파일 업로드 중 발생한 버그 수정
* [Console] 30일이 지난 로그를 검색할 때 발생한 필드 집계 버그 수정

...
See the [TOAST Console Guide](https://docs.toast.com/zh/TOAST/zh/console-guide/) for how to create an organization and a project
...
You can download an SDK from **Analytics > Log & Crash Search** of [TOAST Downloads](https://docs.toast.com/zh/Download/)

...
### 2018.05.02
#### 버그수정
* [SDK] iOS SDK에서 로그 재전송 과정에서 간헐적으로 발생하던 크래시 수정
* [SDK] iOS SDK에서 enableSyncStart 파라미터 YES 초기화 시에 CPU 사용량이 증가 하는 문제 수정
...
### 2017.02.23
#### 기능 개선/변경
* [API] [log Bulk upload](/Analytics/Log%20&%20Crash%20Search/zh/api-guide/) 기능 추가
